...
<table class="table table-hover table-dark">
  <thead>
    <tr>
    	<th class="text-light" scope="col">Colocação</th>
      <th class="text-light" scope="col">Usuario</th>
      <th class="text-light" scope="col">Pontos</th>      
    </tr>
  </thead>
  <tbody>
  
  <c:forEach var="ranking" items="${lista_ranking}" varStatus="id">
    <tr>
      <th class="text-light" scope="row">${id.count}</th>
      <td class="text-light">${ranking.nomeUsuario}</td>
      <td class="text-light">${ranking.pontuacao}</td>
    </tr>
    </c:forEach>
